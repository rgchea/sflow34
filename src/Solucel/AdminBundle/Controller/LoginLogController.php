...
class LoginLogController extends Controller
{
    ...
    protected function initialise()
    {
        ...
        $this->repository = $this->entityManager->getRepository('SolucelAdminBundle:LoginLog');
    ...
    public function listAction(Request $request)
    {
        ...
        $this->get("services")->setVars('systemLog');

        return $this->render('SolucelAdminBundle:LoginLog:index.html.twig');
    ...
    public function listDatatablesAction(Request $request)
    {
        ...
        $results = $em->getRepository('SolucelAdminBundle:LoginLog')->getRequiredDTData($start, $length, $orders, $search, $columns, $otherConditions);

        // Returned objects are of type Town
        $objects = $results["results"];
        // Get total number of objects
        $total_objects_count = $em->getRepository('SolucelAdminBundle:LoginLog')->count(array());
